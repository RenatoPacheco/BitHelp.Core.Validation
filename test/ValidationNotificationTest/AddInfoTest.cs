...
namespace BitHelp.Core.Validation.Test.ValidationNotificationTest
{
    public class AddInfoTest
    {
        ...
        {
            _notification.Clear();
            _notification.AddInfo<SingleValues>(x => x.BoolNull);
            ...
            Assert.Equal(ValidationType.Info, result.Type);
        }
        ...
        {
            _notification.Clear();
            _notification.AddInfo<SingleValues>(x => x.BoolNull, message: "Message here");
        ...
        {
            _notification.Clear();
            _notification.AddInfo<SingleValues>(x => x.BoolNull, message: "{0} message here");
        ...
        {
            _notification.Clear();
            _notification.AddInfo<SingleValues>(x => x.BoolNull, reference: "reference");
        ...
        {
            _notification.Clear();
            _notification.AddInfo("Message here");
        ...
        {
            _notification.Clear();
            _notification.AddInfo("Message here", reference: "reference");
