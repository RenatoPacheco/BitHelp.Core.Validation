...
{
    public class AddUnauthorizedTest
    {
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized<SingleValues>(x => x.BoolNull);
            ...
            Assert.Equal(ValidationType.Unauthorized, result.Type);
        }
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized<SingleValues>(x => x.BoolNull, message: "Message here");
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized<SingleValues>(x => x.BoolNull, message: "{0} message here");
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized<SingleValues>(x => x.BoolNull, reference: "reference");
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized<SingleValues>(x => x.BoolNull, exception: new Exception("Unauthorized here"));

            ValidationMessage result = _notification.Messages.First();

            Assert.Equal("Unauthorized here", result.Exception.Message);
            Assert.Equal(ValidationType.Unauthorized, result.Type);
        }
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized("Message here");
        ...
        {
            _notification.Clear();
            _notification.AddUnauthorized("Message here", reference: "reference", exception: new Exception("Unauthorized here"));
