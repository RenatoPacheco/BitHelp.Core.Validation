...
namespace BitHelp.Core.Validation.Test.ValidationNotificationTest
{
    public class AddAlertTest
    {
        ...
        {
            _notification.Clear();
            _notification.AddAlert<SingleValues>(x => x.BoolNull);
            ...
            Assert.Equal(ValidationType.Alert, result.Type);
        }
        ...
        {
            _notification.Clear();
            _notification.AddAlert<SingleValues>(x => x.BoolNull, message: "Message here");
        ...
        {
            _notification.Clear();
            _notification.AddAlert<SingleValues>(x => x.BoolNull, message: "{0} message here");
        ...
        {
            _notification.Clear();
            _notification.AddAlert<SingleValues>(x => x.BoolNull, reference: "reference");
        ...
        {
            _notification.Clear();
            _notification.AddAlert<SingleValues>(x => x.BoolNull, exception: new Exception("Alert here"));

            ValidationMessage result = _notification.Messages.First();

            Assert.Equal("Alert here", result.Exception.Message);
            Assert.Equal(ValidationType.Alert, result.Type);
        }
        ...
        {
            _notification.Clear();
            _notification.AddAlert("Message here");
        ...
        {
            _notification.Clear();
            _notification.AddAlert("Message here", reference: "reference", exception: new Exception("Alert here"));
