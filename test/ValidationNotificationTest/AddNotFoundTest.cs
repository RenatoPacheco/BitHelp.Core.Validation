...
namespace BitHelp.Core.Validation.Test.ValidationNotificationTest
{
    public class AddNotFoundTest
    {
        ...
        {
            _notification.Clear();
            _notification.AddNotFound<SingleValues>(x => x.BoolNull, exception: new("NotFound here"));
        ...
        {
            _notification.Clear();
            _notification.AddNotFound("Message here", reference: "reference", exception: new("NotFound here"));
