...
{
    public class FloatIsValidExtTest
    {
        ...
        public void Check_value_is_valid(object value)
        {
            ...
            _notification.Clear();
            _notification.FloatIsValid(single.Object);
            Assert.True(_notification.IsValid());

            _notification.Clear();
            _notification.FloatIsValid(single, x => x.Object);
            Assert.True(_notification.IsValid());

            single.Notifications.Clear();
            single.FloatIsValid(x => x.Object);
            Assert.True(single.IsValid());

            single.Notifications.Clear();
            single.FloatIsValid(single.Object);
            Assert.True(single.IsValid());
        }
