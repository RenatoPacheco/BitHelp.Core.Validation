...
{
    public class ByteIsValidExtTest
    {
        ...
        public void Check_value_is_valid(object value)
        {
            ...
            _notification.Clear();
            _notification.ByteIsValid(single.Object);
            Assert.True(_notification.IsValid());

            _notification.Clear();
            _notification.ByteIsValid(single, x => x.Object);
            Assert.True(_notification.IsValid());

            single.Notifications.Clear();
            single.ByteIsValid(x => x.Object);
            Assert.True(single.IsValid());

            single.Notifications.Clear();
            single.ByteIsValid(single.Object);
            Assert.True(single.IsValid());
        }
