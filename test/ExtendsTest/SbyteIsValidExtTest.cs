...
{
    public class SbyteIsValidExtTest
    {
        ...
        public void Check_value_is_valid(object value)
        {
            ...
            _notification.Clear();
            _notification.SbyteIsValid(single.Object);
            Assert.True(_notification.IsValid());

            _notification.Clear();
            _notification.SbyteIsValid(single, x => x.Object);
            Assert.True(_notification.IsValid());

            single.Notifications.Clear();
            single.SbyteIsValid(x => x.Object);
            Assert.True(single.IsValid());

            single.Notifications.Clear();
            single.SbyteIsValid(single.Object);
            Assert.True(single.IsValid());
        }
