...
{
    public class ShortIsValidExtTest
    {
        ...
        public void Check_value_is_valid(object value)
        {
            ...
            _notification.Clear();
            _notification.ShortIsValid(single.Object);
            Assert.True(_notification.IsValid());

            _notification.Clear();
            _notification.ShortIsValid(single, x => x.Object);
            Assert.True(_notification.IsValid());

            single.Notifications.Clear();
            single.ShortIsValid(x => x.Object);
            Assert.True(single.IsValid());

            single.Notifications.Clear();
            single.ShortIsValid(single.Object);
            Assert.True(single.IsValid());
        }
