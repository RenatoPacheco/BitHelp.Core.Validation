...
{
    public class BetweenUlongIsValidExtTest
    {
        private readonly ValidationNotification _notification = new();
        private readonly ulong[] _options = new ulong[] { 1, 2, 3 };
        ...
        public void Check_contain_value_1_valid(bool denay)
        {
            ...
            _notification.Clear();
            _notification.BetweenNumberIsValid(single.Ulong, _options, denay);
            Assert.Equal(!denay, _notification.IsValid());
            ...
            _notification.Clear();
            _notification.BetweenNumberIsValid(single, x => x.Ulong, _options, denay);
            Assert.Equal(!denay, _notification.IsValid());

            single.Notifications.Clear();
            single.BetweenNumberIsValid(x => x.Ulong, _options, denay);
            Assert.Equal(!denay, single.IsValid());

            single.Notifications.Clear();
            single.BetweenNumberIsValid(single.Ulong, _options, denay);
            Assert.Equal(!denay, single.IsValid());
        ...
        public void Check_ignore_null_valid(bool denay)
        {
            ...
            _notification.Clear();
            _notification.BetweenNumberIsValid(single.UlongNull, _options, denay);
            Assert.True(_notification.IsValid());

            _notification.Clear();
            _notification.BetweenNumberIsValid(single, x => x.UlongNull, _options, denay);
            Assert.True(_notification.IsValid());

            single.Notifications.Clear();
            single.BetweenNumberIsValid(x => x.UlongNull, _options, denay);
            Assert.True(single.IsValid());

            single.Notifications.Clear();
            single.BetweenNumberIsValid(single.UlongNull, _options, denay);
            Assert.True(single.IsValid());
        ...
        public void Check_option_empty_exception(bool denay)
        {
            ...
            IList<ulong> options = Array.Empty<ulong>();
