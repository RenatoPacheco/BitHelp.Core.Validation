...
namespace BitHelp.Core.Validation.Test.ExtendsTest
{
    public class DecimalIsValidExtTest
    {
        ...
        public void Check_is_valid()
        {
            ...
            notification.Clear();
            notification.DecimalIsValid<SingleValues>(single, x => x.Decimal);
            Assert.True(notification.IsValid());
        }
        ...
        public void Check_not_number_is_invalid()
        {
            ...
            notification.Clear();
            notification.DecimalIsValid<SingleValues>(single, x => x.String);
            Assert.False(notification.IsValid());
        }
        ...
        public void Check_ignore_null()
        {
            ...
            notification.Clear();
            notification.DecimalIsValid<SingleValues>(single, x => x.DecimalNull);
            Assert.True(notification.IsValid());
        }
    }
}
